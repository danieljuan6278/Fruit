...
func _ready():
	...
	# Connect finished signal for unlimited looping
...
func _on_bgm_finished():
	# This ensures the current background music loops forever
	bgm_player.play()
...
func play_success(): play_sfx(success_snd)
func play_failed(): play_sfx(failed_snd)
func play_buttons(): play_sfx(buttons_snd)
func play_combo(): play_sfx(combo_snd)
func play_game_over(): play_sfx(game_over_snd)
